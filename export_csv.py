...
def save_results_csv(
    ...
    with open(save_path, mode="w", newline="", encoding="utf-8") as file:
        ...
        writer.writerow(["FPS wejsciowe wideo", round(input_fps, 4)])
        writer.writerow(["FPS inferencji", round(inference_fps, 4)])
        writer.writerow(["FPS detekcji", round(detection_fps, 4)])
        writer.writerow(["FPS podgladu", round(display_fps, 4)])
        writer.writerow(["Sr. czas inferencji [ms]", round(avg_infer_ms, 4)])
